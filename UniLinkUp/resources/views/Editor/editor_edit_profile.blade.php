...
<div class="main-content">
    ...
    <div class="back" >
        <a href="{{route('editor_dashboard')}}" class="btn" style="margin-bottom: 20px;">Back</a>
    </div>
        ...
        @endif
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" name="email"value="{{ Auth::guard('editor')->user()->email }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="S_Name" name="S_Name" value="{{ Auth::guard('editor')->user()->E_Name }}">
                </div>
