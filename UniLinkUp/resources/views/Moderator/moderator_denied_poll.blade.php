...
<div class="main-content">
    ...
    <div class="back" >
        <a href="<?=url('moderator_poll')?>" class="btn" style="margin-bottom: 20px;">Back</a>
    </div>

    <div class="container">
        <h1>Denied Publish Request of Poll</h1>
        ...
        @endif
            ...
            <form action="{{ url('/deniedInput') }}" method="post">
                @csrf

                <div class="form-group">
                    <label for="poll_id">Poll Id:</label>
                    <input type="text" id="poll_id" name="poll_id" value="{{ old('poll_id') }}" required>
                    @error('poll_id')
