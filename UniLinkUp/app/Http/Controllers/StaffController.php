    ...
    public function login_submit(Request $request)
{
    try {
        ...
        if (!Auth::guard('staff')->attempt($credentials)) {
            ...
            } else if (Hash::check($request->input('password'), Staff::where('email', $request->input('email'))->first()->password)) {
        ...
        return redirect()->route('staff_login')->with('error', $e->getMessage());
    }
}
